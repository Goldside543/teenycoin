...
# ---------------------------
class Block:
    def __init__(self, index: int, prev_hash: str, transactions: List[Transaction], difficulty=9, timestamp=None, nonce=0):
        self.index = index
...
# ---------------------------
class Blockchain:
    def __init__(self, difficulty=9, mining_reward=1, max_supply=10000000, create_genesis=True):
